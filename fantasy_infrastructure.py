...
# Picks a player to be added to an account through SQL database
# TODO: Switch pick_player() to this function once next season begins
def pick_player_new(person,player,slot=0):
    """For use by the RLPC Newsbot to allow people to pick players for their fantasy
    teams through discord."""
